...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="table-point"><i class="fa-solid fa-location-dot"></i>
                                    Table
                                    Point<a></li>
                            <li><a class="dropdown-item" href="table-polyline"><i class="fa-solid fa-route"></i> Table
                                    Polyline</a></li>
                            <li><a class="dropdown-item" href="table-polygon"><i class="fa-solid fa-draw-polygon"></i>
                                    Table
                                    Polygon</a></li>
                            <li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#infoModal"><i
                                class="fa-solid fa-info"></i> Infone</a>
                    </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Muhammad Nashan Fauzian - 22/498706/SV/21243
                </div>
    ...
    <!-- Leaflet Draw JS mobhhhhhhhhhhhmboh -->
